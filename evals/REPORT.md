...
Over 50 runs cycling through all 50 transcripts (scenarios + YouTube calls): **median 377.857 ms, p95 1605.596 ms** (min 179.393 ms, max 4604.393 ms, mean 709.233 ms). This excludes FastAPI/HTTP overhead — it's pure in-process inference time.
