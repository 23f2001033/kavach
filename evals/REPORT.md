...
|---|---|---|
| `text_only` | 66.7% (10/15) | 13.3% (2/15) |
| `signatures_only` | 13.3% (2/15) | 0.0% (0/15) |
| `fusion_notlow` | 66.7% (10/15) | 20.0% (3/15) |
| `fusion_high_only` | 66.7% (10/15) | 13.3% (2/15) |
...
Over 50 runs cycling through all 50 transcripts (scenarios + YouTube calls): **median 434.443 ms, p95 1923.898 ms** (min 190.19 ms, max 4274.883 ms, mean 749.717 ms). This excludes FastAPI/HTTP overhead — it's pure in-process inference time.
...
|---|---|---|---|---|---|---|
| scam-deepfake-grandchild-emergency | scam | 0.006 | 1 | 0.192 | low | NO |
...
| scam-insurance-bonus-unlock-fee | scam | 0.004 | 0 | 0.004 | low | NO |
| scam-income-tax-fake-notice | scam | 1.000 | 1 | 1.000 | high | yes |
| scam-fake-job-advance-fee | scam | 0.175 | 0 | 0.175 | low | NO |
...
| scam-new-number-parent-whatsapp | scam | 0.000 | 0 | 0.000 | low | NO |
| scam-credit-card-limit-upgrade-otp | scam | 1.000 | 0 | 1.000 | high | yes |
| scam-rental-deposit-token-advance | scam | 0.000 | 0 | 0.000 | low | NO |
| benign-bank-fraud-alert-yes-no | benign | 1.000 | 0 | 1.000 | high | NO |
| benign-police-passport-verification | benign | 0.210 | 0 | 0.210 | low | yes |
| benign-friend-borrow-money | benign | 0.131 | 0 | 0.131 | low | yes |
| benign-customer-care-callback-requested | benign | 1.000 | 0 | 1.000 | high | NO |
| benign-telemarketing-insurance-pitch | benign | 0.000 | 0 | 0.000 | low | yes |
| benign-pta-meeting-reminder | benign | 0.000 | 0 | 0.000 | low | yes |
| benign-landlord-maintenance-call | benign | 0.000 | 0 | 0.000 | low | yes |
| benign-gym-membership-renewal | benign | 0.000 | 0 | 0.000 | low | yes |
| benign-rwa-maintenance-fee-call | benign | 0.000 | 0 | 0.000 | low | yes |
| benign-furniture-delivery-address-confirm | benign | 0.000 | 0 | 0.000 | low | yes |
| benign-college-friend-reunion-call | benign | 0.468 | 0 | 0.468 | suspicious | yes |
| benign-vaccination-reminder-call | benign | 0.000 | 0 | 0.000 | low | yes |
| benign-voter-id-update-camp | benign | 0.000 | 0 | 0.000 | low | yes |
| benign-rd-maturity-informational-call | benign | 0.000 | 0 | 0.000 | low | yes |
| benign-cab-driver-pickup-confirm | benign | 0.000 | 0 | 0.000 | low | yes |

**`signatures_only`**

| id | label | text_score | n_hits | risk_score | risk_level | correct? |
|---|---|---|---|---|---|---|
| scam-deepfake-grandchild-emergency | scam | 0.006 | 1 | 0.192 | low | yes |
...
| bothbosu-youtube-scam-conversations-train-19 | scam | 0.056 | 0 | 0.056 | low | NO |
...
- `fusion_notlow`: `benign-bank-fraud-alert-yes-no`, `benign-customer-care-callback-requested`, `benign-college-friend-reunion-call`
