...
Over 50 runs cycling through all 50 transcripts (scenarios + YouTube calls): **median 546.267 ms, p95 3593.752 ms** (min 198.354 ms, max 9150.402 ms, mean 1161.317 ms). This excludes FastAPI/HTTP overhead — it's pure in-process inference time.
