...
Over 50 runs cycling through all 50 transcripts (scenarios + YouTube calls): **median 446.066 ms, p95 2641.83 ms** (min 211.472 ms, max 6209.598 ms, mean 1054.823 ms). This excludes FastAPI/HTTP overhead — it's pure in-process inference time.
